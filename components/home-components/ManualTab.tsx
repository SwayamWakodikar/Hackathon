          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Input
                ...
                className={isDark ? 'bg-gray-700 border-gray-600 text-white placeholder:text-gray-400' : 'text-black'}
                required
              />
            </div>
            <div>
...
- Wrote comprehensive unit tests achieving 90% code coverage"
            ...
            />
            <p className={`text-sm mt-2 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
              Include job titles, companies, dates, and key achievements with bullet points
            </p>
          </div>
        </div>
...
- Open source project with 500+ GitHub stars"
            ...
            />
            <p className={`text-sm mt-2 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
              Include personal, academic, or open source projects with descriptions
            </p>
          </div>
        </div>
        ...
        <div className="pt-4">
          <Button 
            className={`w-full py-6 text-lg font-semibold ${
              !isDark ? 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white' : 'bg-purple-600 hover:bg-purple-700 text-white'
            }`}
            size="lg"
