...
const features = [
  {
    ...
    title: "AI GENERATION",
    description:
      "Neural-drafted professional narratives built for elite placement.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Generate a complete, industry-ready profile in under 120 seconds.",
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "SECURE DATA",
    description:
      "Industrial-grade encryption to protect your professional identity.",
  },
];
...
export default function AuthHero() {
  return (
    <div
      id="hero"
      className="relative flex items-center justify-center min-h-screen bg-transparent overflow-hidden"
    >
      <div className="px-4 w-full max-w-7xl z-10">
        ...
        <div className="text-center mb-10 relative">
          ...
          <h1 className="relative z-10 mx-auto max-w-4xl text-5xl font-bold tracking-tighter text-white md:text-7xl lg:text-8xl">
            {"Engineer Your Future with".split(" ").map((word, index) => (
              <motion.span
                key={index}
    ...
    "
        ...
        >
          <a
            href="/main"
            className="relative group/btn overflow-hidden px-12 py-5 rounded-2xl bg-transparent border border-white/10 text-zinc-400 font-black text-[12px] tracking-[0.5em] uppercase transition-all duration-300 active:scale-95 hover:border-blue-500/50"
          >
